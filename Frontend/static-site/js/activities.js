...
class ActivitiesManager {
    ...
    displayActivities() {
        ...
        const sortedActivities = filteredActivities.sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime());
    ...
    searchActivities(query) {
        const filtered = this.activities.filter(activity => activity.title.toLowerCase().includes(query.toLowerCase()) ||
